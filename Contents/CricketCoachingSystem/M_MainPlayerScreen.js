...
//             <Text style={styles.teamButtonText}>Player</Text>
...
//               onPress={() => navigation.navigate('AddPlayerScreen')}>
//               <Text style={styles.dropdownButtonText}>Add Player</Text>
//             </TouchableOpacity>
//             <TouchableOpacity
//               style={styles.dropdownButton}
//               onPress={() => navigation.navigate('ViewPlayersScreen')}>
//               <Text style={styles.dropdownButtonText}>View Players</Text>
//             </TouchableOpacity>
//           </View>
//         )}
//       </View>
        ...
        {showDropdown && (
          <View style={styles.dropdown}>
            <TouchableOpacity
              ...
              <View style={styles.centeredContent}>
                <Image
                  source={require('../CricketCoachingSystem/images/addPlayer.png')} // Changed here
            ...
            <TouchableOpacity
              ...
              <View style={styles.centeredContent}>
                <Image
                  source={require('../CricketCoachingSystem/images/viewPlayer.png')}
                  style={styles.dropdownImage}
                />
                <Text style={styles.dropdownButtonText}>View Players</Text>
              </View>
